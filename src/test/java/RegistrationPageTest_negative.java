...
public class RegistrationPageTest_negative  extends RegistrationPage {
    ...
    public void userRegistration_7(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL7);
    ...
    public void userRegistration_8(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL8);
    ...
    public void userRegistration_9(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL9);
    ...
    public void userRegistration_10(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL10);
    ...
    public void userRegistration_11(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL11);
    ...
    public void userRegistration_12(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL12);
        response.then().log().all().statusCode(400);
