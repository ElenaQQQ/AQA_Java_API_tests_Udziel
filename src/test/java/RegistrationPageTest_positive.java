...
public class RegistrationPageTest_positive extends BasePage {
    ...
    public void userRegistration_1(){
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL1);
    ...
    public void userRegistration_2(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL2);
    ...
    public void userRegistration_3(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL3);
    ...
    public void userRegistration_4(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL4);
    ...
    public void userRegistration_5(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL5);
    ...
    public void userRegistration_6(){
        ...
        Response response = registerUser(USER_TEST_PASSWORD, USER_TEST_NAME, USER_EMAIL6);
